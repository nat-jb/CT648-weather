        ...
        {temperatureData.length > 0 ? (
          temperatureData.map((data, index) => (
            <tr key={index} style={{ backgroundColor: index % 2 === 0 ? '#e0f7fa' : '#ffffff' }}>
              <td style={{ padding: '12px', fontWeight: 'bold', color: '#007bff', textAlign: 'left' }}>
                {data.province}
              </td>
              ...
              <td style={{ padding: '12px', color: getTemperatureColor(data.temperature), fontWeight: 'bold', textAlign: 'right' }}>
                {data.temperature ? data.temperature.toFixed(2) : 'N/A'}
              </td>
              <td style={{ padding: '12px', color: getHumidityColor(data.humidity), fontWeight: 'bold', textAlign: 'right' }}>
                {data.humidity ? data.humidity.toFixed(2) : 'N/A'}
              </td>
              <td style={{ padding: '12px', color: getColorForCloudCover(data.cloud), fontWeight: 'bold', textAlign: 'right' }}>
                {data.cloud !== undefined ? `${data.cloud} %` : 'N/A'}
              </td>
              <td style={{ padding: '12px', color: getColorForGust(data.gust_kph), fontWeight: 'bold', textAlign: 'right' }}>
                {data.gust_kph !== undefined ? `${data.gust_kph} km/h` : 'N/A'}
              </td>
              <td style={{ padding: '12px', color: getColorForUV(data.uv), fontWeight: 'bold', textAlign: 'right' }}>
                {data.uv !== undefined ? data.uv : 'N/A'}
              </td>
              <td style={{ padding: '12px', color: getColorForPM25(data.pm25), fontWeight: 'bold', textAlign: 'right' }}>
